...
#ifdef COMMAND_CLASS
// clang-format off
CommandStyle(read_data_new,ReadDataNew);
// clang-format on
#else

#ifndef LMP_READ_DATA_NEW_H
#define LMP_READ_DATA_NEW_H

#include "command.h"

namespace LAMMPS_NS {
class Fix;
class ReadDataNew : public Command {
 public:
  ReadDataNew(class LAMMPS *);
  ~ReadDataNew() override;
