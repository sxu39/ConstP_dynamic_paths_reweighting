...
class Atom : protected Pointers {
 public:
  ...
  void set_Ne(const char *, int, int, char **);  //?
  void set_Ne_dot(const char *, int, int, char **);  //?
  void set_dE_dN(const char *, int, int, char **);  //?
  void data_electronnumber(const char *, int, const char *);  //?
  void data_Ne_dot(const char *, int, const char *);  //?
