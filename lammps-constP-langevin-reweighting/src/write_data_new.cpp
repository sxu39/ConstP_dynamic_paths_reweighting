...
WriteDataNew::WriteDataNew(LAMMPS *lmp) : Command(lmp)
{
...
void WriteDataNew::command(int narg, char **arg)
{
...
void WriteDataNew::write(const std::string &file)
{
  ...
  // for read_data_new, add electron
  std::cout << "-------------------------test write_data_new.cpp-------------------------" << std::endl;
...
void WriteDataNew::force_fields()
{
...
void WriteDataNew::bonus(int flag)
{
...
void WriteDataNew::fix(Fix *ifix, int mth)
{
